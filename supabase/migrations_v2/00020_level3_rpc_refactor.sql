...
-- ========================================
-- PART 1: Refactored RPC Function v2
-- ========================================
-- Note: Helper functions (get_sparkline_data, get_agency_breakdown,
-- get_gestionnaire_breakdown) are defined in migration 00019
-- ========================================
...
--
-- Note: Helper functions are in migration 00019:
--   - get_sparkline_data()
