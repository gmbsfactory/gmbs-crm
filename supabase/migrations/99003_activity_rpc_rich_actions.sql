-- ========================================
-- Enrich recent_actions with entity_meta, old/new values
-- ========================================
-- Ajoute entity_meta (info mini-carte), old_values, new_values
-- pour le redesign du panel actions du jour.
-- Limite augmentee a 200.
