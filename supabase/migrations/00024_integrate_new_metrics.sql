-- Migration 00024: Intégration des Nouvelles Métriques dans get_admin_dashboard_stats_v2
-- Ajoute conversionFunnel, topArtisans et detailedCycleTimes au dashboard stats
...
BEGIN
  ...
  WITH
  -- ========================================
  -- CTEs identiques à la version précédente (00020)
  -- ========================================
  ...
  -- ========================================
  -- Final Result Assembly (avec nouvelles propriétés)
  -- ========================================
...
COMMENT ON FUNCTION public.get_admin_dashboard_stats_v2 IS
  'Optimized RPC v2 with new metrics: conversion funnel, top artisans, detailed cycle times. Target: ~200ms';

-- ========================================
-- Summary
-- ========================================
-- ✅ Intégré get_conversion_funnel() dans get_admin_dashboard_stats_v2
-- ✅ Intégré get_top_artisans() dans get_admin_dashboard_stats_v2
-- ✅ Intégré get_detailed_cycle_times() dans get_admin_dashboard_stats_v2
-- ✅ Ajouté tauxTransformation et tauxMarge dans mainStats
--
-- Les nouvelles propriétés retournées:
--   - conversionFunnel: Array de {statusCode, count, conversionRate}
--   - topArtisans: Array de {artisanId, artisanName, nbInterventions, ca, marge, tauxMarge}
--   - detailedCycleTimes: {demandeToDevis, devisToAccepte, accepteToTerminee, totalCycleTime}
-- ========================================
