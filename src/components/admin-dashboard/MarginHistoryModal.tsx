...
import { useMarginHistory } from "@/hooks/useMarginHistory"
import type { PeriodType } from "@/lib/api/v2"
import { Skeleton } from "@/components/ui/skeleton"
import { AlertCircle } from "lucide-react"

interface MarginHistoryModalProps {
  open: boolean
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Évolution de la Marge Globale</DialogTitle>
          <DialogDescription>
        ...
        {isLoading ? (
          ...
          <VerticalBarChart
            data={chartData}
            title="Évolution de la Marge Globale"
